"""
training/train_deeplabv3plus.py — DeepLabV3+ training entry point
...
def main():
    parser = argparse.ArgumentParser(description="Train DeepLabV3+ on IDD-AW")
    parser.add_argument("--config", default="dissertation/configs/deeplabv3plus.yaml")
