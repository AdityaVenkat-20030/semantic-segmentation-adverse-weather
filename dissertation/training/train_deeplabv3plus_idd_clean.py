"""
training/train_deeplabv3plus_idd_clean.py

DeepLabV3+ training entry point for clean IDD dataset.
...
python -m dissertation.training.train_deeplabv3plus_idd_clean \
    --config dissertation/configs/deeplabv3plus_idd_clean.yaml \
    --resume dissertation/results/deeplabv3plus_idd_clean/checkpoint_epoch010.pth
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Train DeepLabV3+ on clean IDD"
    )
