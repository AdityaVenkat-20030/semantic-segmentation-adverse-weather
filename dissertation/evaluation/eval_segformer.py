"""
evaluation/eval_segformer.py

Evaluate SegFormer checkpoint on IDD-AW validation set.
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate SegFormer checkpoint on IDD-AW"
    )
    ...
    parser.add_argument(
        "--checkpoint",
        default="dissertation/results/segformer/best_checkpoint.pth",
    )
    ...
    output_dir = Path(
        config.get("output_dir", "dissertation/results/segformer")
    )
