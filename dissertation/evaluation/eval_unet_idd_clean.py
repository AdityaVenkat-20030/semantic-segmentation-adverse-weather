"""
evaluation/eval_unet_idd_clean.py

Evaluate U-Net checkpoint on clean IDD validation set.
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate U-Net checkpoint on clean IDD"
    )
    ...
    parser.add_argument(
        "--checkpoint",
        default="dissertation/results/unet_idd_clean/best_checkpoint.pth",
    )
    ...
    output_dir = Path(
        config.get("output_dir", "dissertation/results/unet_idd_clean")
    )
