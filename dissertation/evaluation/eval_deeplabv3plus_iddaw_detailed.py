"""
evaluation/eval_deeplabv3plus_iddaw_detailed.py

Detailed DeepLabV3+ evaluation on IDD-AW.
...
python -m dissertation.evaluation.eval_deeplabv3plus_iddaw_detailed \
    ...
    --output_dir dissertation/results/deeplabv3plus/detailed_eval
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Detailed DeepLabV3+ evaluation on IDD-AW"
    )
    ...
    print("\nDetailed DeepLabV3+ evaluation complete.")
