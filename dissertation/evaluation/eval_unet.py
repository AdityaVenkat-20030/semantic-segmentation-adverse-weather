...
Evaluate trained U-Net checkpoint on IDDAW validation set.

Usage:
python -m dissertation.evaluation.evaluate_unet \
    --config dissertation/configs/unet.yaml \
    --checkpoint results/unet/best_checkpoint.pth
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate trained U-Net checkpoint"
    )
    ...
    parser.add_argument(
        "--checkpoint",
        default="results/unet/best_checkpoint.pth",
    )
    ...
    output_dir = Path(
        config.get("output_dir", "results/unet")
    )
