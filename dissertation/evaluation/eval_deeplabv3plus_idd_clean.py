"""
evaluation/eval_deeplabv3plus_idd_clean.py

Evaluate DeepLabV3+ checkpoint on clean IDD validation set.
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate DeepLabV3+ checkpoint on clean IDD"
    )

    parser.add_argument(
        "--config",
        default="dissertation/configs/deeplabv3plus_idd_clean.yaml",
    )

    parser.add_argument(
        "--checkpoint",
        default="dissertation/results/deeplabv3plus_idd_clean/best_checkpoint.pth",
    )
    ...
    output_dir = Path(
        config.get(
            "output_dir",
            "dissertation/results/deeplabv3plus_idd_clean",
        )
    )
