"""
evaluation/eval_segformer_idd_clean.py

Evaluate SegFormer checkpoint on clean IDD validation set.
...
def compute_metrics(confusion_matrix):
    ...
    iou_per_class[valid] = true_positive[valid] / denominator[valid]
...
def save_summary(output_dir, metrics):
    output_file = output_dir / "evaluation_summary_idd_clean.csv"
...
def save_per_class_iou(output_dir, class_names, per_class_iou):
    output_file = output_dir / "per_class_iou_idd_clean.csv"
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate SegFormer checkpoint on clean IDD"
    )
    ...
    parser.add_argument(
        "--checkpoint",
        default="dissertation/results/segformer_idd_clean/best_checkpoint.pth",
    )
    ...
    output_dir = Path(
        config.get("output_dir", "dissertation/results/segformer_idd_clean")
    )
    ...
    np.save(
        output_dir / "confusion_matrix_idd_clean.npy",
        confusion_matrix,
    )
