"""
evaluation/eval_segformer_iddaw_detailed.py

Detailed SegFormer evaluation on IDD-AW.
...
python -m dissertation.evaluation.eval_segformer_iddaw_detailed \
    ...
    --output_dir dissertation/results/segformer/detailed_eval
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Detailed SegFormer evaluation on IDD-AW"
    )
    ...
    print("\nDetailed SegFormer evaluation complete.")
